...
public class CharacterStats : MonoBehaviour
{
    ...
    public Stat intelligence;//法力  1 point increase magic damage by 1 and magic resistance by 3
    public Stat vitality;//活力   1 point incredase health by  5 points 
    ...
    public bool isIgnited;//随着时间造成伤害
    ...
    public virtual void DoMagicalDamage(CharacterStats _targetStats)
    {
        ...
        bool flowControl = AttemptToApplyAilements(_targetStats, _fireDamage, _iceDamage, _lightningDamage);
        if (!flowControl)
        {
            return;
        }
    ...
    private  bool AttemptToApplyAilements(CharacterStats _targetStats, int _fireDamage, int _iceDamage, int _lightningDamage)
    {
    ...
    private void HitNearestTargetWithShockStrike()
    {
        ...
        if (closestEnemy != null)
        {
            ...
            newShockStrike.GetComponent<ShockStrike_Comtroller>().Setup(shockDamage, closestEnemy.GetComponent<CharacterStats>());
        }
    }
