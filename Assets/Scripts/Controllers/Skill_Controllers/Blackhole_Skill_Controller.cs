...
public class Blackhole_Skill_Controller : MonoBehaviour
{
    ...
    private void RelsaseCloneAttack()
    {
        if(targets.Count <= 0)
            return;
    ...
    private void CloneAttackLogic()
    {
        if (cloneAttackTimer < 0 && cloneAttackReleased && amountOfAttacks > 0)
        {
            ...
            int randmIndex = Random.Range(0, targets.Count);
            ...
            else
            {
                ...
                SkillManager.instance.clone.CreateClone(targets[randmIndex], new Vector3(xOffset, 0.4f));
            }
